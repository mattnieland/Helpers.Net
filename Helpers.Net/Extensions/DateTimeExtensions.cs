...
namespace Helpers.Net.Extensions
{
    ...
    public static class DateTimeExtensions
    {
        ...
        public static DateTime ToSpecificTimeZone(this DateTime timeUtc, TimeZoneInfo localTimeZone)
        {
            localTimeZone = (localTimeZone ?? TimeZoneInfo.Local);
            if (timeUtc.Kind != DateTimeKind.Unspecified)
                timeUtc = new DateTime(timeUtc.Ticks, DateTimeKind.Unspecified);

            return TimeZoneInfo.ConvertTimeFromUtc(timeUtc, localTimeZone);
        }
